...
namespace Scandiweb\StoreFinder\Model\ResourceModel\Rsvp\Grid;
...
class Collection extends RsvpCollection implements SearchResultInterface
{
    ...
    {
        parent::_construct();
        $this->_init(static::CLASS_DATA_PROVIDER_DOCUMENT, RsvpResource::class);
    }
