...
namespace Scandiweb\StoreFinder\Controller\Adminhtml\Rsvp;
...
class Index extends Action
{
    ...
    protected function _isAllowed()
    {
        ...
        return $this->_authorization->isAllowed('Scandiweb_StoreFinder::rsvp');
    }
    ...
    protected function _setPageData($resultPage)
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Event RSVP'));
        $resultPage->addBreadcrumb(__('Store Finder'), __('Store Finder'))
            ->addBreadcrumb(__('RSVP List'), __('RSVP List'));
