...
class Uploader
{
     ...
     * @var string
     */
    const IMAGE_TMP_PATH = 'cmssimplebadge/tmp/images/image';
    /**
     * @var string
     */
    const IMAGE_PATH = 'cmssimplebadge/images/image';
    /**
     * @var string
     */
    const FILE_TMP_PATH = 'cmssimplebadge/tmp/images/file';
    /**
     * @var string
     */
    const FILE_PATH = 'cmssimplebadge/images/file';
